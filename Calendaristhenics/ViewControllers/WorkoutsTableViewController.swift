...
class WorkoutsTableViewController: UITableViewController {
    ...
    var staticCellAtTheTop: StaticCellAtTheTop?
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            if staticCellAtTheTop == nil {
                staticCellAtTheTop = (tableView.dequeueReusableCell(withIdentifier: "staticCellAtTheTop", for: indexPath) as! StaticCellAtTheTop)
                staticCellAtTheTop!.button.removeTarget(nil, action: nil, for: .allEvents)
                staticCellAtTheTop!.button.addTarget(self, action: #selector(createAllEvents(_:)), for: .touchUpInside)
            }
    ...
    @objc func createEvent(_ sender: Any) {
        ...
        createCalendarEvent(forWorkout: workout)
        try! eventStore.commit()
    }
    
    @objc func createAllEvents(_ sender: Any) {
    ...
    private func createCalendarEvent(forWorkout workout: Workout) {
